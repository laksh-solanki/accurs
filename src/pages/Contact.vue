        ...
        <div class="col-lg-5">
          <div class="contact-info p-4 rounded shadow-lg mb-4">
            ...
            <ul class="list-unstyled">
              <li class="mb-3">
                <i class="bi bi-geo-alt-fill me-3"></i> 123 Tile Street,
                Flooring City, FC 12345
              </li>
              <li class="mb-3">
                <i class="bi bi-telephone-fill me-3"></i> +1 (123) 456-7890
              </li>
              <li class="mb-3">
              ...
              <li class="mb-3">
                <i class="bi bi-clock-fill me-3"></i> Mon - Fri: 9:00 AM - 5:00
                PM
              </li>
            </ul>
          </div>
